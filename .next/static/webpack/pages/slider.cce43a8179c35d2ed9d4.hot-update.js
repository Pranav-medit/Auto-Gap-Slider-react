...
var SlickSlider = function SlickSlider() {
  ...
  }, 1000); // const throttler  = (callBack,limit)=>{
  //   let wait = false; 
  //   return ()=>{
  //     if (!wait){
  //       callBack()
