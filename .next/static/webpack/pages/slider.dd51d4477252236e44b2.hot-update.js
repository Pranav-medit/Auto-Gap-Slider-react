...
var SlickSlider = function SlickSlider() {
  ...
  var throttler = function throttler(callBack) {
    ...
    return function () {
      if (!wait) {
        callBack.apply(void 0, (0,C_Users_prana_Documents_VSCode_React_react_hooks_hook1_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(ars));
        wait = true;
        setTimeout(function () {
          wait = false;
        }, 3000);
