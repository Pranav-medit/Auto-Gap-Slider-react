  ...
  var clickHandler = function clickHandler(direction) {
    ...
    if (direction === 'next') {
      ...
      if (endOfSlide) {
        ...
        // else if divCardsContainerWidth is eq
