...
var SlickSlider = function SlickSlider() {
  ...
  //     // const totalNumberOfSlides = document.getElementsByClassName('div__sliderCard--slideCalulate').length
  //     const sliderVisibleWidth = slickSliderMainContainer.current.offsetWidth;
  //     const eachSlideWidth = childSliderCardRef.current.offsetWidth
  //     const slidesPerVisibleWidth = sliderVisibleWidth/(eachSlideWidth+minGapBetweenSlides);
  //     const marginToSetInPercentage = slidesPerVisibleWidth - Math.floor(slidesPerVisibleWidth)
  //     const marginToSetInPx = ((marginToSetInPercentage)*eachSlideWidth+minGapBetweenSlides)
  //     const marginPerSlide = (marginToSetInPx/slidesPerVisibleWidth)
