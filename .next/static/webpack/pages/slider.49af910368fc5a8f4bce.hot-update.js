...
var SlickSlider = function SlickSlider() {
  ...
  var throttleer = function throttleer(callBack, limit) {
    var wait = false;
    return function () {
      if (!wait) {
        callBack();
