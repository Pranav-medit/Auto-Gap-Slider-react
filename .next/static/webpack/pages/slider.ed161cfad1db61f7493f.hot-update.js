  ...
  var clickHandler = function clickHandler(direction) {
    ...
    if (direction === 'next') {
      ...
      if (endOfSlide) {
        ...
        resetSliderPosition(); // ex: say divCardsContainerWidth = 2890px;
