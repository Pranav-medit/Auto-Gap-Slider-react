...
var SlickSlider = function SlickSlider() {
  ...
  function setStyle(className, styleValue) {
    updateSlideMargin(styleValue); // let items = document.getElementsByClassName(className);
