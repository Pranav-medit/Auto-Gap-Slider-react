...
var SlickSlider = function SlickSlider() {
  ...
  var styleImg = {
    width: '200px',
    height: '300px',
    margin: "0 ".concat(cardMargin / 2, "px 0 ").concat(index === imgArr.length ? 0 : cardMargin / 2, "px")
  };
