  ...
  var clickHandler = function clickHandler(direction) {
    ...
    if (direction === 'next') {
      ...
      if (pxToScrlLeft > 0) {
        ...
        divCardsContainer.current.style.cssText = "transform: translateX(".concat(pxToScrlLeft, "px)"); // Update slider position reference, pass false to update refrence with respect to next button click
