...
var SlickSlider = function SlickSlider() {
  ...
  var touchEndHandler = function touchEndHandler(e) {
    ...
    if (touchEndPos === touchStartPos) if (touchEndPos - touchStartPos > 0) clickHandler('prev');else clickHandler('next');
  };
