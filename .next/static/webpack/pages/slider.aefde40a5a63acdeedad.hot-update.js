...
var sliderStyles = {
  ...
  nextButton: function (_nextButton) {
    function nextButton(_x) {
      return _nextButton.apply(this, arguments);
    }

    nextButton.toString = function () {
      return _nextButton.toString();
    };
    ...
    return {
      display: nextButton ? "inline-block" : "none"
    };
  }),
