...
var SlickSlider = function SlickSlider() {
  ...
  function setStyle(className, displayValue) {
    ...
    for (var i = 0; i < items.length; i++) {
      if (i === 0) if (i === items.length) items[i].style.display;
