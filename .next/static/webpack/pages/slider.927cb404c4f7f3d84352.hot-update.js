...
var SlickSlider = function SlickSlider() {
  ...
  function setStyle(className, styleValue) {
    ...
    for (var i = 0; i < items.length; i++) {
      items[i].style.margin = "0 ".concat(styleValue, "px 0 zzzzz");
